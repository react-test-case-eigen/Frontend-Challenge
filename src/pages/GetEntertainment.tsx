...
const GetEntertainmnet: FC = () => {
  const [newsDatas, setNewsDatas] = useState<NewsType[]>([]);
  useEffect(() => {
    axios
      .get(
        `https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=9d9eedd661544b8da8bce1e167383b3c`
      )
      .then((res) => {
  ...
  return (
    <Layout>
      <div className="px-5 bg-slate-100 my-20">
        <p className="text-2xl font-semibold py-14">Entertainment</p>
...
export default GetEntertainmnet;
